...
class Display:
    ...
    def update_state_display(self):
        if self.blackboard.game.state:
            state = self.blackboard.game.state.self.blackboard.game_state[6:]
            if state == 'READY' or state == 'SET':  # kickoff
                color = RED_COLOR if self.blackboard.game.kickoff == self.blackboard.game.red.id else BLUE_COLOR
            else:
                color = 0x000000
        else:
            state = ''
    ...
    def update_score_display(self):
        ...
        self.blackboard.supervisor.setLabel(5, score, 0, 0, self.font_size, BLACK_COLOR, 0.2, self.font)
    ...
    def update_details_display(self):
        ...
        self.blackboard.supervisor.setLabel(12, strings.white, 0, y, self.font_size, WHITE_COLOR, 0.2, self.font)
    ...
    def update_team_display(self):
        ...
        left_color = RED_COLOR if self.blackboard.game.side_left == self.blackboard.game.red.id else BLUE_COLOR
        right_color = BLUE_COLOR if self.blackboard.game.side_left == self.blackboard.game.red.id else RED_COLOR
